...
class NativePackedAssemblerOutputs:
    ...
    option_positions: torch.Tensor  # (B, max_options) int32, legacy ABI scratch
    option_mask: torch.Tensor  # (B, max_options) uint8, legacy ABI scratch
    target_positions: torch.Tensor  # (B, max_options, max_targets) int32, legacy ABI scratch
    target_mask: torch.Tensor  # (B, max_options, max_targets) uint8, legacy ABI scratch
