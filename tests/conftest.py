...
import magic_ai.ppo as _ppo  # noqa: E402

_orig = getattr(_ppo._gae_returns_batched_compiled, "_torchdynamo_orig_callable", None)
if _orig is not None:
    _ppo._gae_returns_batched_compiled = _orig  # type: ignore[assignment]
